...
| 09/14 | [Introduction](/chapters/introduction/task_selection) | |
...
<!-- :::info
The **Pivot Checkpoint** (10/19) is a hard milestone: every team presents its current feasibility and, if the original scope isn't achievable, commits to a reduced scope for the remainder of the semester. This replaces open-ended "keep trying" drift with a single, enforced decision point.
::: -->
