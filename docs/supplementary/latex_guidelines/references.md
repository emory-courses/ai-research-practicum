...
Our [template](https://www.overleaf.com/read/yjnvxcjrgghv) uses `acl_natbib.bst` to format the bibliography, indicated in `acl.sty`:
...
Our [template](https://www.overleaf.com/read/yjnvxcjrgghv) uses `custom.bib`, is indicated at the bottom of `acl_latex.tex`, for adding references to be included in the paper:
