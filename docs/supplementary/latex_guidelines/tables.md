...
* See the other explanations for the [Tables in Column](/supplementary/latex_guidelines/tables#tables-in-column).
...
* See [Tables in Page](/supplementary/latex_guidelines/tables#tables-in-page) to create sub-tables that expand to the full page.
