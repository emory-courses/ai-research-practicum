...
* See the other explanations for the [Figures in Column](/supplementary/latex_guidelines/figures#figures-in-column).
...
* See [Figures in Page](/supplementary/latex_guidelines/figures#figures-in-page) to create sub-tables that expand to the full page.
